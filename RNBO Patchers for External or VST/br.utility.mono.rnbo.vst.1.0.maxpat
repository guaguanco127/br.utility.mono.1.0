...
,
		"classnamespace" : "box",
		"rect" : [ -466.0, -1026.0, 1163.0, 881.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 294.0, 128.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 294.0, 207.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 550.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 39.0, 373.0, 48.0, 136.0 ],
...
, 												{
													"box" : 													{
														"maxclass" : "newobj",
														"text" : "in 3 @comment \"Bass dB Mix, 0 = -0 dB, 1 = -3 db,  2 = -6 dB\" @default 2",
														"numinlets" : 0,
														"patching_rect" : [ 587.0, 19.0, 402.0, 22.0 ],
														"numoutlets" : 1,
														"outlettype" : [ "" ],
														"id" : "obj-11"
													}
...
, 												{
													"box" : 													{
														...
														"text" : "out 2",
														"numinlets" : 1,
														"patching_rect" : [ 311.0, 500.0, 35.0, 22.0 ],
														"numoutlets" : 0,
														"id" : "obj-6"
													}
...
, 												{
													"box" : 													{
														...
														"text" : "out 1",
														"numinlets" : 1,
														"patching_rect" : [ 70.0, 488.0, 35.0, 22.0 ],
														"numoutlets" : 0,
														"id" : "obj-4"
													}
...
,
									...
									"patching_rect" : [ 150.5, 304.0, 103.0, 23.0 ],
									"rnbo_classname" : "gen~",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 347.0, 158.0, 269.0, 23.0 ],
...
,
									"text" : "param \"Bass Mix dB\" 2 @enum 0. -3. -6. @order 2",
									"varname" : "Bass Mix dB"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 134.0, 51.0, 228.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"displayorder" : "-",
										"unit" : "",
...
,
									"text" : "param On/Off 0 @enum Off On @order 1",
									"varname" : "On/Off"
								}
						...
						"export_config" : 						{
							"max-export" : 							{
								"max-external-export" : 								{
									...
									"description" : "A basic object that sums the signal below the cutoff frequency to mono while leaving frequencies about the cutoff in stereo",
									"mc" : 1,
									"external_name" : "br.utility.monobass.1.0~"
								}
...
,
					"patching_rect" : [ 42.0, 284.0, 126.0, 22.0 ],
					"rnboattrcache" : 					{
						"On/Off" : 						{
							"label" : "On/Off",
							"isEnum" : 1,
