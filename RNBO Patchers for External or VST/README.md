# Max/MSP RNBO Patches for External of VST Creation: br.utility.mono.1.0  
...
br.utility.mono.rnbo.ext.1.0 is a patch set up to export as a Max/MSP external.  
...
2. Open up br.utility.mono.rnbo.ext.1.0.maxpat using Max/MSP 
...
2. Open up br.utility.mono.rnbo.vst.1.0.maxpat using Max/MSP 
